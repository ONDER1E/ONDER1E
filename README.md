Hello, not many people see, this.
...
- 😎 I Have used countless IT systems (Cloud platforms, a variety of software and machine-managment applications, as of writing this I'm currently administering my homelab/lackrack consisting of two servers, one running Windows server datacentre 2022 and the other on Truenas (Fangtooth), though it will be used primarily as a NAS server, it has lots of ECC registered RAM so I plan for the visualisation of many VMs)
